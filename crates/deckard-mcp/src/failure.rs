...
pub fn from_deny_reason(reason: &str, config_dir: Option<&Path>) -> Failure {
    ...
    match reason {
        ...
        "shield_to_mismatch" => Failure::new(
        ...
        "erc20_unsupported_v1" | "unsupported_v1" => Failure::new(
